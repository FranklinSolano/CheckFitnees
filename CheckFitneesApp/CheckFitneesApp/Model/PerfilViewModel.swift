...
class PerfilViewModel {
    ...
    func createPerfilModel(name: String, carb: String, proteina: String, gordura: String, title: String, buttonGeneric: String, image: UIImage?) -> PerfilModel {
    ...
    func popularDatapopular() {
        ...
        let buttonGenerics = ["Calcular Medidade", "Calcular", "Calcular", "Calcular Dieta", "Calcular Carboidratos", "Calcular Treino", "Calcular Volume de Treino", "Check Evolução"]
        let images: [UIImage?] = [UIImage(named: "medidas"),UIImage(named: "taxa"), UIImage(named: "porcentual"), UIImage(named: "dieta"), UIImage(named: "ciclo"), UIImage(systemName: "dumbbell.fill"), UIImage(systemName: "figure.run.square.stack.fill"), UIImage(named: "grafico")]
